...
const developmentTimeline = [
  {
    period: "2005–2006",
    detail:
      "U.S. patent published October 27, 2005 and issued in 2006 for the Leg-Ankle-Foot Exercise Assembly (inventor: Luis Alberto Commisso)—a user-driven platform guiding the foot, ankle, and lower leg through multiple paths of movement with adjustable resistance.",
  },
  {
    period: "2019–2021",
    detail:
    ...
    >
      <article className={styles.project}>
        ...
        <p className={styles.elevator}>
          ...
          designed to support, guide, and resist specific human foot movements—minimizing inappropriate
          external forces while enabling natural three-dimensional motion. Built on decades of
        ...
        <section className={styles.section}>
          ...
          <div className={styles.patentAbstract}>
            ...
            <p className={styles.patentAbstractSource}>
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                Google Patents — US20050239611A1
              </a>
            </p>
          </div>
          <blockquote className={styles.patentQuote}>
            ...
            <footer>— U.S. Patent US20050239611A1</footer>
          </blockquote>
          <p className={styles.body}>
